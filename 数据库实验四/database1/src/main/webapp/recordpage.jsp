...
<div id="search">
    <div id="inner_s">
        ...
        <button  id="btn2" style="font-size: 18px; height: 28px;">打卡</button>
        <button  id="btn3" style="font-size: 18px; height: 28px;">图鉴</button>
        <button  id="btn4" style="font-size: 18px; height: 28px;">喂食记录</button>
    </div>
    <script>
        ...
        btn002.onclick=function ()
        {
            ...
            window.location.href="clockin?cat_id="+catid_str+"&username="+username_str+"&cat_position="+position_str+"&record_time="+time_str;
